...
public class Task1 {
    /**
     * Используем HashMap ввиду её алгоритмической сложности
     * на получение элемента -- O(1). Такая сложность будет иметь место быть,
     * пока в хэш-мапе ключи имеют попарно различный хэш.
     */
